...
public class BarangBaru extends javax.swing.JFrame {
    ...
    public BarangBaru(String id, String level) {
        initComponents();
        ...
        this.id = id;
        cek();
        JOptionPane.showMessageDialog(null, "Untuk hasil maksimal, kami rekomendasikan ukuran foto\n180x178 :) Terimakaish...");
    }
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(gambar, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(reset)
                                    .addComponent(stok, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap())
        );
    ...
    private void publishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_publishActionPerformed
        // TODO add your handling code here:
            if(cek2()){
                try {
                String sql = "INSERT INTO `taufik_barang`(`id_barang`, `nama_brg`, `kategori_brg`, `harga`, `desk_brg`, `id_seller`, `photo`, `stok`) VALUES (NULL,?,?,?,?,?,?,?)";
                java.sql.Connection conn=(Connection)Config.configDB();
                java.sql.PreparedStatement pst=conn.prepareStatement(sql);
                pst.setString(1, nama.getText());
                pst.setString(2, (String) kategori.getSelectedItem());
                pst.setInt(3, parseInt(harga.getText()));
                pst.setString(4, desk.getText());
                pst.setInt(5, parseInt(this.id));
                pst.setBytes(6, photo);
                pst.setInt(7, parseInt(stok.getText()));
                pst.execute();
                JOptionPane.showMessageDialog(null, "Barang Berhasil di Publish");
                hapus();
                } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Sebelum meng-upload produk\nSilahkan isi profil anda terlebih dahaulu\nTerimakasih :)");
                }
            } else {
               JOptionPane.showMessageDialog(null, "Tidak boleh ada field yg kosong!!!"); 
            }
